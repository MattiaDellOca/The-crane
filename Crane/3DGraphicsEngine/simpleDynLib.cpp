...
////////////
   ...
   // Reserved pointer:
bool SimpleDynLib::initFlag = false;
 ...
 */
bool LIB_API SimpleDynLib::init()
{
    // Prevent double init:
    if (initFlag)
    {
 ...
 * @return true on success, false on error
 */
bool LIB_API SimpleDynLib::free()
{
    // Really necessary?
    if (!initFlag)
    {
 ...
 * @return true on success, false on error
 */
bool LIB_API SimpleDynLib::doNothing()
{

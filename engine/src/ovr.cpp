 ...
 */
glm::mat4 LIB_API OvVR::ovr2ogl(const vr::HmdMatrix34_t& matrix)
{
 ...
 */
glm::mat4 LIB_API OvVR::ovr2ogl(const vr::HmdMatrix44_t& matrix)
{
 ...
 */
glm::mat4 LIB_API OvVR::getProjMatrix(OvEye eye, float nearPlane, float farPlane)
{
	switch (eye)
	{
 ...
 */
glm::mat4 LIB_API OvVR::getEye2HeadMatrix(OvEye eye)
{
	switch (eye)
	{
 ...
 */
unsigned int LIB_API OvVR::getNrOfControllers()
{
 ...
 */
Controller LIB_API* OvVR::getController(unsigned int pos) const
{
 ...
 */
void LIB_API OvVR::pass(OvEye eye, unsigned int eyeTexture)
{
